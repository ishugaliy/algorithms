...
public class RaskinBobbins {
    ...
    public static void main(String[] args) {
        ...
        findOptimalFlavours_1(4, new int[]{1, 4, 5, 3, 2});
        // sorted {2,2,3,4}
        System.out.print("expected: 1 2 actual: ");
        findOptimalFlavours_1(4, new int[]{2, 2, 4, 3});
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            for (int i = 1; i <= numOfTrips; i++) {
                ...
                // algorithm
                findOptimalFlavours_1(m, flavours);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    // SOLUTION # 1 O(n)
    private static void findOptimalFlavours_1(int m, int[] f) {
    ...
    public static void findOptimalFlavours_2(int m, int[] n) {
        // O(n log n)
        ...
        //  O(n) - map founded idx in sorted arr with indexes of source arr
        int nLeft = -1;
        int nRight = -1;
        ...
        int[] result = IntStream.of(nLeft, nRight).sorted().toArray();
